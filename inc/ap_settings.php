...
global $ap_implementation, $ap_premium_link, $ap_datap, $ap_customp, $css_arr, $ap_group;
...
<div class="icon32" id="icon-options-general"><br></div><h2>Alphabetic Pagination <?php echo '('.$ap_datap['Version'].($ap_customp?') Pro':')'); ?> - Settings</h2> <div class="ap_video_tutorial">Help Required? Click here!</div>
...
<h4>Shortcode:</h4> <?php if(!$ap_customp){ ?><a href="<?php echo $ap_premium_link; ?>" title="This is a premium feature." target="_blank">Go Premium for Shortcode</a><?php } ?><br />
<br />
...
<div class="ap_grouping_label"><b>Alphabets Grouping?</b></div>

<fieldset>
	<p>
   <label for="ap_group_yes">
		<input type="radio" <?php echo ($ap_group==1?'checked="checked"':''); ?> class="tog" id="ap_group_yes" value="1" name="ap_grouping">Yes</label>
	</p>
    <p>
   <label for="ap_group_no">
		<input type="radio" <?php echo ($ap_group==1?'':'checked="checked"'); ?> class="tog" id="ap_group_no" value="0" name="ap_grouping">No</label>
	</p>
</fieldset>
<small class="hide">Save changes to have effect.</small>
</div>
</td>
</tr>
...
<small>Note: Multiple taxonomies can be selected.</small>
</fieldset>
...
<small>Note: Multiple items can be selected. Exclude will overwrite include.</small>
</fieldset>
