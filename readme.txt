...
<iframe width="420" height="315" src="//www.youtube.com/embed/N-ewX28pLXs" frameborder="0" allowfullscreen></iframe>
...
7. Settings Example#2
8. Premium Features#1
...
1.	Download the Alphabetic Pagination installation package and extract the files on
	...
	your computer. 
2.	Create a new directory named `Alphabetic Pagination` in the `wp-content/plugins`
...
1.	Download the Alphabetic Pagination installation package and extract the files on
	...
	your computer. 
2.	Upload the new PHP files to `wp-content/plugins/Alphabetic Pagination`,

	overwriting any existing Alphabetic Pagination files that are there.
...
4.	Enjoy your newer and hotter installation of Alphabetic Pagination
