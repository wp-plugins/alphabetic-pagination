...
<fieldset>
    ...
    <select name="ap_dom" id="dom_selector">
        ...
        <?php endforeach; ?>
        <?php if(get_option('ap_dom')!='' && !in_array(get_option('ap_dom'), $dom_selectors)): ?>
...
<fieldset>
    ...
    <select class="ap_taxes" name="ap_tax[]" id="tax_selector" multiple="multiple">
    	...
    	<option value="<?php echo $tax; ?>" <?php echo in_array($tax, get_option('ap_tax'))?'selected="selected"':''; ?>><?php echo $tax; ?></option>    
        <?php endforeach; ?>  
    </select>
