...
*/ 
	...
	global $ap, $arg, $ap_implementation, $rendered, $ap_premium_link, $ap_datap, $ap_dir, $alphabets_bar, $ap_customp, $ap_queries, $ap_query, $css_arr, $disabled_letters, $ap_current_cat, $ap_group;
	$disabled_letters = array();
	$arg = 'ap';
	$ap_dir = plugin_dir_path( __FILE__ );
	$css_arr = array('');
	$ap_customp = file_exists($ap_dir.'inc/functions_extended.php');
	$ap_queries = 0;
	$ap_query = false;
	$rendered = FALSE;
