...
*/ 
	...
	global $ap, $arg, $ap_implementation, $rendered, $premium_link, $ap_data, $ap_dir, $alphabets_bar, $ap_custom, $ap_queries, $ap_query, $css_arr, $disabled_letters, $ap_current_cat, $ap_group;
